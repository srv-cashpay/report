...
func (h *domainHandler) SlowMoving(c echo.Context) error {
	...
	data, err := h.serviceRproduct.SlowMoving(start, end, req.Filter, req.Status, req.MerchantID) // <== tambah req.Status
	if err != nil {
